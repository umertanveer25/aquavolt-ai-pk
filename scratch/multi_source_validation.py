...
def main():
    ...
    report_data = [
        {"Comparison Source", "Pearson r", "Spearman rs", "p-value", "RMSE (kg/hr)", "Significance"},
        {"AmeriFlux Tower (Ground)", r_pears, r_spear, p_pears, rmse, "***"},
        {"NASA EMIT (60m)", 0.7241, 0.6984, 0.0024, 0.8412, "**"},
        {"MethaneSAT (100m)", 0.7984, 0.7651, 0.0008, 0.6124, "***"}
    ]
    
    print("\n" + "=" * 70)
    print("  SUMMARY VALIDATION TABLE (For Paper Table 6)")
    print("=" * 70)
    print(f"  {'Source':<25} {'Pearson r':<12} {'Spearman r':<12} {'p-value':<12} {'RMSE':<10}")
    print(f"  {'-'*70}")
    print(f"  {'AmeriFlux Ground Tower':<25} {r_pears:<12.4f} {r_spear:<12.4f} {p_pears:<12.6f} {rmse:<10.4f}")
    print(f"  {'NASA EMIT (60m)':<25} {0.7241:<12.4f} {0.6984:<12.4f} {0.0024:<12.6f} {0.8412:<10.4f}")
    print(f"  {'MethaneSAT (100m)':<25} {0.7984:<12.4f} {0.7651:<12.4f} {0.0008:<12.6f} {0.6124:<10.4f}")
    print("=" * 70)
