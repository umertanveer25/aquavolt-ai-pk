...
%% ------------------------------------------------------------------
The study area is focused on the Russell Ranch Agricultural Facility, UC Davis, California ($38.551^\circ$ N, $-121.882^\circ$ W). The pipeline extracts Sentinel-5P bias-corrected column values and composites them monthly using a mean reducer to eliminate cloud occlusion gaps. 
...
We validate our downscaled estimates against NASA EMIT, MethaneSAT L4 assets, and the AmeriFlux US-Wrr ground covariance tower ($38.5382^\circ$ N, $-121.7617^\circ$ W).
