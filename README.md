...
**Latest Update:** `2026-07-02 19:00:00 UTC`
...
- **Air Temp:** 25.8°C
- **Humidity:** 54%
- **Solar Radiation:** 950.0 W/m²
- **Soil Moisture (Proxy):** 6.9%
- **Reference ET₀ (24h):** 6.66 mm

### 🌱 Field Averages (Current Hour)

| Field Name | Avg NDVI | Avg NDWI | Avg ETc (mm/hr) | Avg Water Deficit (mm) |
|---|---|---|---|---|
| **Field-A (Corn)** | 0.197 | -0.261 | 1.02 | **51.02** |
| **Field-B (Alfalfa)** | 0.194 | -0.274 | 1.08 | **51.76** |
