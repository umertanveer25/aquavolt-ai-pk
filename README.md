...
**Latest Update:** `2026-07-01 16:00:00 UTC`
...
- **Air Temp:** 19.0°C
- **Humidity:** 69%
- **Solar Radiation:** 528.0 W/m²
- **Soil Moisture (Proxy):** 8.2%
- **Reference ET₀ (24h):** 6.86 mm

### 🌱 Field Averages (Current Hour)

| Field Name | Avg NDVI | Avg NDWI | Avg ETc (mm/hr) | Avg Water Deficit (mm) |
|---|---|---|---|---|
| **Field-A (Corn)** | 0.197 | -0.261 | 1.05 | **51.02** |
| **Field-B (Alfalfa)** | 0.194 | -0.274 | 1.11 | **51.76** |
